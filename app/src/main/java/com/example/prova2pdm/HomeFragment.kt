...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerAtorList.adapter = adapter
        ...
        binding.recyclerAtorList.layoutManager = layout

        binding.recyclerAtorList.addOnItemTouchListener(
            RecyclerViewClickListener(this.requireContext(),
                binding.recyclerAtorList,
